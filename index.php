                        ...
                        <div id="featured_row1" class="row" >
                            ...
                            <div id="livefeed_column" class="span4 offset_livefeed_column">
                                ...
                                <div class="tile triple">
                                    <h3><a href="?id=1_"><?php print_r($eventlist[0]['DESCRIPTION']); echo"<p> on </p> "; print_r($eventlist[0]['TIME']); echo" - "; printusername($eventlist[0]['authID']); ?></a></h3>
                                </div>

                                <div class="tile triple">
                                    <h3><a href="?id=1_"><?php print_r($eventlist[1]['DESCRIPTION']); echo"<p> on </p> "; print_r($eventlist[1]['TIME']); echo" - "; printusername($eventlist[1]['authID']); ?></a></h3>
                                </div>

                                <div class="tile triple">
                                    <h3><a href="?id=1_"><?php print_r($eventlist[2]['DESCRIPTION']); echo"<p> on </p> "; print_r($eventlist[2]['TIME']); echo" - "; printusername($eventlist[2]['authID']); ?></a></h3>
                                </div>

                                <div class="tile triple">
                                    <h3><a href="?id=1_"><?php print_r($eventlist[3]['DESCRIPTION']); echo"<p> on </p> "; print_r($eventlist[3]['TIME']); echo" - "; printusername($eventlist[3]['authID']); ?></a></h3>
                                </div>
